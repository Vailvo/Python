...
tip_each = tip / 100 * bill
tip_each = "{:.2f}". format(tip_each)
split_bill = int(input("How many people to split the bills?\n"))
each_per = split_bill / tip_each
print(round(each_per, 2))
...
print(f"Each person should pay ${final_bill} with a tip each of ${tip_each}")
